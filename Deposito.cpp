// Deposito.cpp
// Definiciones de las funciones miembro para la clase Deposito.
...
void Deposito::ejecutar()
{
    ...
    if ( monto != CANCELO )
    {
        ...
        if ( sobreRecibido )
        {
            ...
            // abona a la cuenta para ref lejar el depósito
...
double Deposito::pedirMontoADepositar() const
{
    ...
    {
        return static_cast< double >( entrada ) / 100; // devuelve el monto en dólares
    } // fin de else
} // fin de la función pedirMontoADepositar